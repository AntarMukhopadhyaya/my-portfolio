...
const EmailSection = () => {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // Step 1: Add a state for loading
  ...
  return (
    <>
      {isSubmitting ? (
        <div className="flex space-x-2 justify-center items-center  h-screen bg-transparent text-white">
        ...
        >
          ...
          >
            ...
            <p className="text-[#ADB7BE] mb-4 max-w-md">
              ...
              potential collaborators, and anyone interested in web development,
              machine learning, and cyber security. Whether you have a question,
